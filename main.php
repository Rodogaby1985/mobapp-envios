...
/* =============================== */
/* == MEJORA: PROTECCIÓN FLUSH REDIS CACHE Y RECARGA AUTOMÁTICA DE TARIFAS == */
/* =============================== */
...
/* == MEJORA: Helper que recarga tarifas automáticamente si Redis/cache fue flusheado == */
...
function mobapp_add_common_fields(&$form_fields) {
    ...
    // Iconos sugeridos debajo del campo
...
// Aplica la negrita automática en el label
...
/* Cargar CSS del tooltip si el usuario usa la clase mobapp-tooltip */
...
/* Repite el mismo patrón para:
   - CORREO ARGENTINO SUCURSAL (datos_csv_ca_suc, gid=1897873008)
   - ANDREANI DOMICILIO (datos_csv_andreani_dom, gid=506491561)
   - ANDREANI SUCURSAL (datos_csv_andreani_suc, gid=2067361143)
   - OCA DOMICILIO (datos_csv_oca_dom, gid=98567282)
   - OCA SUCURSAL (datos_csv_oca_suc, gid=1766360152)
   - URBANO DOMICILIO (datos_csv_urbano_dom, gid=1666417641)
   Solo cambia el transient y la URL según corresponda. El resto de la funcionalidad (campos, negrita, iconos en el admin) será igual.
*/
